    ...
    public static class DbInitializer
    {
        public static void Initialize(AlmacenesContext context) {
            ...
            var movimientos = new Movimiento[]
            {
                ...
                new Movimiento{MovDate = DateOnly.FromDateTime(DateTime.Today).AddDays(3), MovAlmId = 1, MovMatId = 1, MovQuantity = -5m, MovUnitPrice = 0.15m, Estantes = Movimiento.EstantesEnum.A, Niveles = Movimiento.NivelesEnum.N0, Cajas = Movimiento.BoxEnum.B0, MovType = Movimiento.MovTypeEnum.Salida },
                ...
                new Movimiento{MovDate = DateOnly.FromDateTime(DateTime.Today).AddDays(6), MovAlmId = 2, MovMatId = 2, MovQuantity = -1m, MovUnitPrice = 1.15m, Estantes = Movimiento.EstantesEnum.E, Niveles = Movimiento.NivelesEnum.N6, Cajas = Movimiento.BoxEnum.B6, MovType = Movimiento.MovTypeEnum.Salida},
